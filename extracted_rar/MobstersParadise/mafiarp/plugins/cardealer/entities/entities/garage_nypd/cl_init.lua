-- "gamemodes\\mafiarp\\plugins\\cardealer\\entities\\entities\\garage_nypd\\cl_init.lua"
...
if (CLIENT) then
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		drawText("NYPD Garage Platform", x, y, colorAlpha(configGet("color"), alpha), 1, 1, nil, alpha * 0.65)
