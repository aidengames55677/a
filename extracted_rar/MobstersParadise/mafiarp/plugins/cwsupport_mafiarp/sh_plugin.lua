	...
	do
		...
		for k, v in ipairs(weapons.GetList()) do
			...
			elseif (class:find("doi_")) then
				prefix = "doi_"
			elseif (class:find("bo_aron_")) then
				prefix = "bo_aron_"
			elseif (class:find("type_")) then
				prefix = "bo_aron_"
			elseif (class:find("stoner_")) then
				prefix = "bo_aron_"
			elseif (class:find("khr_")) then
				prefix = "bo_aron_"
			elseif (class:find("det_")) then
				prefix = "bo_aron_"
			elseif (class == "m40a5") then
				prefix = "cw_"
			elseif (class:find("weapon_l4d2_")) then
				prefix = "l4d2_"
			end
