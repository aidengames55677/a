-- "gamemodes\\mafiarp\\plugins\\doors\\entities\\weapons\\nut_keys.lua"
...
function SWEP:PrimaryAttack()
	...
	if (IsValid(entity) and
		(
			...
			(entity:IsVehicle() and ((entity.CPPIGetOwner and entity:CPPIGetOwner() == self.Owner) || entity.canLockVehicle && entity.canLockVehicle[self.Owner:getChar():getID()]))
		)
	) then
...
function SWEP:SecondaryAttack()
	...
	*/
	if (IsValid(entity) and
		(
			(entity:isDoor() and entity:checkDoorAccess(self.Owner)) or
			(entity:IsVehicle() and ((entity.CPPIGetOwner and entity:CPPIGetOwner() == self.Owner) || entity.canLockVehicle[self.Owner:getChar():getID()]))
		)
	) then
