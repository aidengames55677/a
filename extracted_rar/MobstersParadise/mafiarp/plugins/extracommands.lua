...
nut.command.add("rules", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://docs.google.com/document/d/1ZCVgvFcgKwQNbe5aHuYSRhA9iXt0CHfyYFvMJnFn5uo/edit?usp=drivesdk")]])
	end
})
...
nut.command.add("content", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	client:SendLua([[gui.OpenURL("https://steamcommunity.com/sharedfiles/filedetails/?id=1689316394")]])
	end
})
...
nut.command.add("discord", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://discord.gg/rypsHzY")]])
	end
})
