include( "shared.lua" )
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		drawText("Police Supply Locker", x, y, colorAlpha(configGet("color"), alpha), 1, 1, nil, alpha * 0.65)
...
net.Receive( "locker_menu", function()
...
locker_frame:SetTitle("Police Department Supply Locker");
...
for k, v in pairs( Locker_List ) do
...
equip_button.DoClick = function()
	...
	net.Start( "Mission_Start_2", LocalPlayer() )
		net.WriteString( k )
	net.SendToServer()
