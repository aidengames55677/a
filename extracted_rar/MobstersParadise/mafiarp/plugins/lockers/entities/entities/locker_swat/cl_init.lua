include( "shared.lua" )
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		drawText("SWAT Supply Locker", x, y, colorAlpha(configGet("color"), alpha), 1, 1, nil, alpha * 0.65)
...
net.Receive( "locker_menu_swat", function()
...
locker_frame:SetTitle("SWAT Supply Locker");
...
for k, v in pairs( Locker_List_Swat ) do
...
equip_button.DoClick = function()
	...
	net.Start( "Mission_Start_22", LocalPlayer() )
		net.WriteString( k )
	net.SendToServer()
