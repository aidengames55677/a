-- "gamemodes\\mafiarp\\plugins\\modified_charcreation\\derma\\cl_character_slot.lua"
...
function PANEL:confirmDelete()
	...
	vgui.Create("nutCharacterConfirm")
		:setMessage(L("Deleting a character cannot be undone, and will activate a cooldown that will prevent you from joining the faction this character is in for 7 days."))
		:onConfirm(function()
