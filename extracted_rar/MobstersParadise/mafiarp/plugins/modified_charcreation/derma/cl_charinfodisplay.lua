-- "gamemodes\\mafiarp\\plugins\\modified_charcreation\\derma\\cl_charinfodisplay.lua"

local PANEL = {}
PANEL.material = Material("diverge/id.png", "noclamp smooth")
...
vgui.Register("SWCharInfoDisplay", PANEL, "DFrame") 