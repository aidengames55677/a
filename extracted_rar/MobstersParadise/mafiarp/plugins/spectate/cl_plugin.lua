-- "gamemodes\\mafiarp\\plugins\\spectate\\cl_plugin.lua"
...
local function drawHelp()
    ...
    for i = 1, #pls do
        ...
        draw.WordBox(2, x, y - 66, "Name: " .. ply:Nick(), "UiBold", uiBackground, uiForeground)
        if ply:getChar() then
            draw.WordBox(2, x, y - 46, "Faction: " .. nut.faction.indices[ply:Team()].name, "UiBold", uiBackground, uiForeground)   
            --draw.WordBox(2, x, y - 6, "Weapon: " .. ply:GetActiveWeapon():GetClass() or "none", "UiBold", uiBackground, uiForeground)
        else
            draw.WordBox(2, x, y - 46, "Faction: Not Loaded", "UiBold", uiBackground, uiForeground)
            draw.WordBox(2, x, y - 6, "Weapon: None", "UiBold", uiBackground, uiForeground)
        end
        draw.WordBox(2, x, y - 26, "Health: " .. ply:Health(), "UiBold", uiBackground, uiForeground)
    end
