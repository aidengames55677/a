-- "gamemodes\\mafiarp\\entities\\entities\\nut_item.lua"
...
if (SERVER) then
    ...
    function ENT:setItem(itemID)
		...
		local worldModel = itemTable:getData("worldModel")
		if worldModel then 
			model = worldModel
		end
        self:SetModel(model)
	...
	function ENT:Think()
		...
		if itemTable && (itemTable.uniqueID == "weed_plant" or itemTable.uniqueID == "drug_lab") then
