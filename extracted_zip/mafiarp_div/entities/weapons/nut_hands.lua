-- "gamemodes\\mafiarp\\entities\\weapons\\nut_hands.lua"
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:sam_get_play_time() < 3600 then
		self.Owner:ChatPrint("You may not utilise the punch function with less than an hour playtime! Type !time to check your playtime.")
		return false
	end
