-- "gamemodes\\mafiarp\\plugins\\bonemerge\\entities\\entities\\clothing_vendor\\cl_init.lua"
...
function ENT:onDrawEntityInfo(alpha)
    ...
    drawText("Irrelevant Clerk", x, y, colorAlpha(configGet("color"), alpha), 1, 1, nil, alpha * 0.65)
