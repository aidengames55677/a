-- "gamemodes\\mafiarp\\plugins\\bonemerge\\entities\\entities\\clothing_vendor_vip\\cl_init.lua"
...
function ENT:onDrawEntityInfo(alpha)
    ...
    drawText("Joseph Mamani", x, y, colorAlpha(configGet("color"), alpha), 1, 1, nil, alpha * 0.65)
