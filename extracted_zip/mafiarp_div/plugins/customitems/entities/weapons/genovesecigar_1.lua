-- "gamemodes\\mafiarp\\plugins\\customitems\\entities\\weapons\\genovesecigar_1.lua"
...
SWEP.PrintName = "Santino's Semplice Leggero"

SWEP.Instructions = "LMB : Smoke Exotic"

SWEP.cigaAccentColor = nil

SWEP.cigaID = 4
SWEP.ViewModel = "models/diverge/genovesecigars/v_cigar1.mdl"
SWEP.WorldModel = "models/diverge/genovesecigars/cigar1.mdl"
