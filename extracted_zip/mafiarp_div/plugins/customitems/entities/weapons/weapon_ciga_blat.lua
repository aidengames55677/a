-- "gamemodes\\mafiarp\\plugins\\customitems\\entities\\weapons\\weapon_ciga_blat.lua"


-- Cigarette SWEP by Mordestein (based on Vape SWEP by Swamp Onions)
-- Viewmodel fixed by Ultra
...
SWEP.cigaID = 4
SWEP.ViewModel = "models/polievka/v_cigar.mdl"
SWEP.WorldModel = "models/polievka/cigar.mdl"
