...
function SKIN:PaintListViewLine(panel, w, h)
    surface.SetDrawColor((panel:IsHovered() or panel:IsLineSelected()) and nut.config.get("color", Color(255,255,255)) or Color(0,0,0,0))
    surface.DrawRect(0, 0, w, h)
end

function SKIN:PaintScrollBarGrip(panel, w, h)
    surface.SetDrawColor(nut.config.get("color", Color(255,255,255)))
    surface.DrawRect(0, 0, w, h)
end
...
function SKIN:PaintTextEntry(panel, w, h)
    ...
    panel:DrawTextEntryText( color_white, panel:GetHighlightColor(), panel:GetCursorColor() )
end
...
function SKIN:PaintComboBox(panel, w, h)
    ...
    panel:DrawTextEntryText(color_white, color_white)
end
