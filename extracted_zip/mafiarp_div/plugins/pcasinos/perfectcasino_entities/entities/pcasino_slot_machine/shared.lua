-- "gamemodes\\mafiarp\\plugins\\pcasinos\\perfectcasino_entities\\entities\\pcasino_slot_machine\\shared.lua"
...
PerfectCasino.Core.RegisterEntity("pcasino_slot_machine", {
	...
	jackpot = {
		...
		startValue = {d = 100, t = "num"}, -- Jackpot start value
		betAdd = {d = 0.3, t = "num"}, -- The % of the bet to add to the jackpot
	},
	-- Chance data
	chance = {
		bell = {d = 20}, -- The bell chance
		melon = {d = 10}, -- The watermelon chance
		cherry = {d = 8}, -- The cherry chance
		seven = {d = 8}, -- The seven chance
		clover = {d = 8}, -- The clover chance
		diamond = {d = 4}, -- The diamond chance
		berry = {d = 2}, -- The strawberrry chance
		dollar = {d = 0.2} -- The dollar chance
	},
},
