-- "gamemodes\\mafiarp\\plugins\\police\\entities\\entities\\armory_police\\cl_init.lua"
...
include( "shared.lua" )
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		drawText("Standard Police Armory", x, y, colorAlpha(configGet("color"), alpha), 1, 1, nil, alpha * 0.65)
...
net.Receive( "armory_menu_police", function()
...
locker_frame:SetTitle("Standard Police Armory");
...
for k, v in pairs( nut.plugin.list.police.Lockers.Police.Selections ) do
if !v.Cadet && !LocalPlayer():getChar():hasFlags("L") then continue end
