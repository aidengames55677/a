...
if (CLIENT) then
	...
	function PLUGIN:HUDPaint()
		...
		for k, v in ipairs(player.GetAll()) do
			if (
				v ~= localPlayer and
				(v:getNetVar("typing") or v.Talking) and
				...
				local posOffset = v.Crouching(v) and TYPE_OFFSET_CROUCHED or TYPE_OFFSET
				posOffset = Vector(posOffset.x, posOffset.y, posOffset.z * v:GetModelScale())

				position = v:GetPos() + posOffset
